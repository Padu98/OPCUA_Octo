...
conString = "" #Storage Account connation String
...
def startProcessing(text):
   # print('Processor started using path: ' + os.getcwd())
    ...
    container = ContainerClient.from_connection_string(conString, container_name="edgejobdata")
...
def converPrinterTemperature (dicti):
 #   print(dicti)
    if('status'in dicti['restResult'] and dicti['restResult']['status'] == 'empty'):
